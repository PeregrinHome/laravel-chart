...
var graphicsCvaize = {
    ...
    helpers: {
        translit: {
            ...
            cyrill_to_latin: function cyrill_to_latin(text) {
            ...
            latin_to_cyrill: function latin_to_cyrill(text) {
    ...
    modalsFun: {
        ...
        del: function del(target, id, name) {
        ...
        add: function add(target, id, name) {
        ...
        //     }
        // },
        showToken: function showToken(target, id, name) {
    ...
    modal_trigger: function modal_trigger() {
    ...
    refreshToken: function refreshToken(input, btn) {
        if ($('*').is(input) && $('*').is(btn)) {
    ...
    convertLCinit: function convertLCinit(l, c) {
        $(c).keyup(function () {
        ...
        create: {
            time_graph: {
                add_line: {
                    ...
                    t: function t(btn_target, box, selecter_item, data_types) {
    ...
    graphics: {
        create: {
            formation: function formation(id, data, title) {
                ...
                Highcharts.stockChart(id, {
                    ...
                    rangeSelector: {
                        buttons: [{ type: 'day', count: 1, text: '1д' }, { type: 'day', count: 3, text: '3д' }, { type: 'month', count: 1, text: '1м' }, { type: 'month', count: 3, text: '3м' }, { type: 'month', count: 6, text: '6м' }, { type: 'ytd', count: 1, text: 'YTD' }, { type: 'year', count: 1, text: '1г' }, { type: 'all', text: 'Всё' }],
                        selected: 0
                    },
                    tooltip: {
            ...
            target: function target(selector_btn, selector_form) {
